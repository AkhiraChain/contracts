...
contract AkhiraRegistryTest is IAkhiraRegistryData, BaseTest {
    // Target contract
    AkhiraRegistry internal _registry;
    ...
    function setUp() public override {
        super.setUp();
        actor = getActor(0);
        _registry = AkhiraRegistry(registry);
    }
