...
contract AkhiraFactoryTest is IAkhiraFactoryData, BaseTest {
    // Target contract
    AkhiraFactory internal _factory;
    ...
    function setUp() public override {
        ...
        _factory = AkhiraFactory(factory);
        proxyDeployer = getActor(10);
        proxyDeployer2 = getActor(11);

        vm.prank(factoryAdmin);
        mockModule = new MockAkhiraContract();
    }
    ...
    function test_addImplementation_directV2() public {
        MockAkhiraContractV2 mockModuleV2 = new MockAkhiraContractV2();
    ...
    function test_deployProxyByImplementation(bytes32 _salt) public {
        ...
        assertEq(mockModule.contractType(), MockAkhiraContract(computedProxyAddr).contractType());
    }
    ...
    function skiptest_deployProxyDeterministic_emit_ProxyDeployed() public {
        ...
        bytes32 salt = bytes32("Random");
        bytes memory proxyBytecode = abi.encodePacked(type(AkhiraProxy).creationCode, abi.encode(address(mockModule), ""));
    ...
    function test_deployProxy() public {
        ...
        assertEq(mockModule.contractType(), MockAkhiraContract(proxyAddr).contractType());
    }
