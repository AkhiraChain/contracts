...
contract AkhiraFee is IAkhiraFee, Multicall, ERC2771Context, AccessControlEnumerable, IFeeTierPlacementExtension {
    /// @dev The factory for deploying contracts.
    AkhiraFactory public immutable factory;
    ...
    constructor(address _trustedForwarder, address _factory) ERC2771Context(_trustedForwarder) {
        factory = AkhiraFactory(_factory);
