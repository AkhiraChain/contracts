    ...
    function payout(
        ...
        try IERC2981Upgradeable(_listing.assetContract).royaltyInfo(_listing.tokenId, _totalPayoutAmount) returns (
            ...
            if (royaltyFeeRecipient != address(0) && royaltyFeeAmount > 0) {
                require(royaltyFeeAmount + platformFeeCut + akhiraFeeCut <= _totalPayoutAmount, "fees exceed the price");
        ...
        CurrencyTransferLib.transferCurrencyWithWrapper(
            ...
            _payer,
            _payee,
            _totalPayoutAmount - (platformFeeCut + royaltyCut + akhiraFeeCut),
            _nativeTokenWrapper
        );
    }
