...
import "../interfaces/IAkhiraContract.sol";
...
import { IAkhiraFee } from "../interfaces/IAkhiraFee.sol";
    ...
    IDropERC1155
{
    ...
    function collectClaimPrice(
        ...
        CurrencyTransferLib.transferCurrency(_currency, _msgSender(), akhiraFeeRecipient, akhiraFee);
        CurrencyTransferLib.transferCurrency(_currency, _msgSender(), recipient, totalPrice - platformFees - akhiraFee);
    }
